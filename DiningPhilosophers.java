...
public class DiningPhilosophers {
    ...
    static int noOfPhilosophers = 5;
    static Philosopher philosophers[] = new Philosopher[noOfPhilosophers];
    static Fork forks[] = new Fork[noOfPhilosophers];
    ...
    public static void main(String argv[]) {
        ...
        for (int i = 0; i < noOfPhilosophers; i++) {
            philosophers[i] = new Philosopher(i, forks[i], forks[(i + 1) % noOfPhilosophers]);
